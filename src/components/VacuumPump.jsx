  ...
  return (
    <div className="section-inner">
      <div className="pump-section reveal" style={{ marginTop: '80px', display: 'grid', gridTemplateColumns: '0.8fr 1.2fr', gap: '60px', alignItems: 'start' }}>
        ...
        <div className="pump-img-wrap" style={{ padding: '0', background: 'transparent', border: 'none', borderRadius: '24px', overflow: 'hidden', display: 'block', marginTop: '108px', boxShadow: 'var(--shadow-md)' }}>
